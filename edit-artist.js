...
const checkPaintings = function () {
    let paintings = [];
    document.querySelectorAll('#painting-checkboxes input[type="checkbox"]').forEach(e => {
        console.log(e.checked, 'checked');
        if (e.checked) {
...
const checkDrawings = function () {
    let drawings = [];
    document.querySelectorAll('#drawing-checkboxes input[type="checkbox"]').forEach(e => {
        console.log(e.checked, 'checked');
        if (e.checked) {
...
const check3D = function () {
    let threeD = [];
    document.querySelectorAll('#threeD-checkboxes input[type="checkbox"]').forEach(e => {
        if (e.checked) {
            threeD.push(e.name)
            mediums.push(e.name)
        }
