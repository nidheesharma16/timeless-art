...
function getColumnHTML() {
    ...
    htmlData += '<div class="paragraph-regular-2 margin-bottom-20">World Class Curators</div>';
    htmlData += '<div class="paragraph-regular-2 margin-bottom-20">25 Art listing</div>';
    htmlData += '<div class="paragraph-regular-2 margin-bottom-20">60 minutes complimentary</div>';
